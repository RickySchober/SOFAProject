...
from testController import DataCollectionController
from NNcontroller import NeuralNetController
...
def createScene(rootNode):
    ...
    # Collect references to all Finger nodes for logging
    print("Creating NN controller")
    fingers = [rootNode.getChild(f"Finger{i+1}") for i in range(1)]
    rootNode.addObject(NeuralNetController(node=rootNode, finger=fingers))
